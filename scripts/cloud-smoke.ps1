...
Assert-HeaderValue $healthResponse "API health" "Cross-Origin-Opener-Policy" "same-origin"
Assert-HeaderValue $healthResponse "API health" "Cross-Origin-Resource-Policy" "same-origin"
Assert-HeaderValue $healthResponse "API health" "X-Permitted-Cross-Domain-Policies" "none"
...
if ($WebUrl) {
  ...
  Assert-HeaderValue $webHome "Web home" "Cross-Origin-Opener-Policy" "same-origin"
  Assert-HeaderValue $webHome "Web home" "Cross-Origin-Resource-Policy" "same-origin"
  Assert-HeaderValue $webHome "Web home" "X-Permitted-Cross-Domain-Policies" "none"
