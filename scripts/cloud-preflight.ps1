...
foreach ($needle in @("lexflow-api", "lexflow-postgres", "lexflow-redis", "REQUIRE_PRODUCTION_READY", "SEED_DEMO_ON_STARTUP", "LEXFLOW_WEB_URL", "CREDENTIAL_ENCRYPTION_KEY", "REQUIRE_OWNER_MFA", "FAILED_LOGIN_LIMIT", "FAILED_LOGIN_WINDOW_MINUTES")) {
